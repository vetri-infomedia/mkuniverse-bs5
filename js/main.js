...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const booksData = [
    {
      ...
      badge: "Bestseller",
      summary:
        "A breathtaking story of memory, regret, and the courage to rewrite one’s destiny. When a mysterious manuscript surfaces in a seaside cottage, two estranged siblings must unravel their family’s darkest secrets before time runs out.",
      format: "Hardcover",
      pages: 432,
    ...
    },
    {
      ...
      badge: "Popular",
      summary:
        "Set against the misty highlands of Scotland, two souls torn apart by circumstance reunite under extraordinary conditions. A heart-wrenching tale about second chances and unspoken truths.",
      format: "Paperback",
      pages: 368,
    ...
    },
    {
      ...
      summary:
        "An evocative memoir-style exploration of how literature shapes our empathy, sharpens our minds, and connects us across centuries of human experience.",
      format: "Hardcover",
      pages: 312,
      publisher: "Novelia Publishing",
    ...
    },
    {
      ...
      badge: "New Release",
      summary:
        "A high-stakes thriller involving a disgraced journalist who stumbles upon an unsolved 1920s cold case buried deep within a forgotten city archive.",
      format: "Paperback",
      pages: 400,
      publisher: "Aurelian Press",
    ...
    },
    {
      ...
      badge: "Award Winner",
      summary:
        "An epic saga spanning three generations across turbulent global shifts, celebrating resilience, heritage, and the enduring power of hope.",
      format: "Hardcover",
      pages: 512,
      publisher: "Novelia Publishing",
    ...
    },
    {
      ...
      summary:
        "A curated compilation of fifteen intimate short stories that capture the quiet beauty of late-night solitude and fleeting human moments.",
      format: "Paperback",
      pages: 240,
      publisher: "Aurelian Press",
  ...
  const storiesData = [
    ...
    },
    {
      ...
      date: "July 2026",
      excerpt:
        "A chance meeting at a centuries-old tea house brings together two strangers running from their pasts...",
      content: `
    ...
    },
    {
      ...
      date: "June 2026",
      excerpt:
        "Found inside an antique desk, a letter written in 1944 reveals a timeless message of hope...",
      content: `
  ...
  function openQuickViewModal(bookId) {
    ...
    document.getElementById("qv-book-rating").textContent =
  ...
  if (sections.length > 0) {
    ...
    navLinks.forEach((link) => {
      link.addEventListener("click", (e) => {
        ...
        if (target) {
          const navHeight =
            document.querySelector(".navbar-novelia").offsetHeight;
    ...
    collapseContent.addEventListener("click", (e) => {
      ...
      if (anchor && collapseContent.classList.contains("show")) {
        const collapseInstance =
          bootstrap.Collapse.getInstance(collapseContent);
        if (collapseInstance) {
  ...
  const orderNowBtn = document.querySelector(
    '[data-bs-target="#whatsappOrderModal"]',
  );
  if (orderNowBtn) {
